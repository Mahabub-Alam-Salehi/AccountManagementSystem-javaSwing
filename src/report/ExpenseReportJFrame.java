 ...
 * @author JABA002
 */
public class ExpenseReportJFrame extends javax.swing.JFrame {
    ...
    private void cmd_ireportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_ireportActionPerformed
        ...
        if (start_date.equals("")) {
            ...
            try {
                ...
                JasperDesign jd = JRXmlLoader.load("E:\\AMS\\AccountManagementSystem\\src\\report\\ExpenseReport.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpenseReportJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExpenseReportJFrame().setVisible(true);
            }
        });
    }
